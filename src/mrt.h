...
// https://www.iana.org/assignments/mrt/mrt.xhtml#table-dump-v2-subtype-codes
...
# if __BYTE_ORDER == __LITTLE_ENDIAN
  ...
  RIB_GENERIC = 0x0600,
  GEO_PEER_TABLE = 0x0700,  // RFC6397
  RIB_IPV4_UNICAST_ADDPATH = 0x0800,  // RFC8050
  RIB_IPV4_MULTICAST_ADDPATH = 0x0900,
  RIB_IPV6_UNICAST_ADDPATH = 0x0a00,
  RIB_IPV6_MULTICAST_ADDPATH = 0x0b00,
  RIB_GENERIC_ADDPATH = 0x0c00
# else // __BIG_ENDIAN
  ...
  RIB_GENERIC = 0x06,
  GEO_PEER_TABLE = 0x07,  // RFC6397
  RIB_IPV4_UNICAST_ADDPATH = 0x08,  // RFC8050
  RIB_IPV4_MULTICAST_ADDPATH = 0x09,
  RIB_IPV6_UNICAST_ADDPATH = 0x0a,
  RIB_IPV6_MULTICAST_ADDPATH = 0x0b,
  RIB_GENERIC_ADDPATH = 0x0c
# endif // __BIG_ENDIAN
};
...
// https://www.iana.org/assignments/mrt/mrt.xhtml#BGP4MP_ET-codes
...
# if __BYTE_ORDER == __LITTLE_ENDIAN
  ...
  BGP4MP_MESSAGE_ADDPATH = 0x0800, // RFC8050
  BGP4MP_MESSAGE_AS4_ADDPATH = 0x0900,
  BGP4MP_MESSAGE_LOCAL_ADDPATH = 0x0a00,
  BGP4MP_MESSAGE_AS4_LOCAL_ADDPATH = 0x0b00
# else // __BIG_ENDIAN
  ...
  BGP4MP_MESSAGE_ADDPATH = 0x08, // RFC8050
  BGP4MP_MESSAGE_AS4_ADDPATH = 0x09, 
  BGP4MP_MESSAGE_LOCAL_ADDPATH = 0x0a,
  BGP4MP_MESSAGE_AS4_LOCAL_ADDPATH = 0x0b
# endif // __BIG_ENDIAN
};
...
# if __BYTE_ORDER == __LITTLE_ENDIAN
#define htonll(x) (((uint64_t)htonl((uint32_t) ((x) & 0xFFFFFFFFUL) ) << 32)\
